...
const sampleDecks = {
  ...
  "english-diction": { title: "English A Diction & Context", cards: [
    { front: "Diction", back: "The writer's choice of words and their effect" },
    { front: "Connotation", back: "The emotional or cultural association of a word" },
    { front: "Denotation", back: "The literal dictionary meaning of a word" },
    { front: "Tone", back: "The writer's attitude conveyed through word choice" },
    { front: "Register", back: "Level of formality — formal or informal language" },
    { front: "Colloquial", back: "Informal, conversational language" },
    { front: "Formal language", back: "Standard, precise language used in serious writing" },
    { front: "Jargon", back: "Specialized vocabulary used by a particular group" },
    { front: "Slang", back: "Very informal, often short-lived words" },
    { front: "Nuance", back: "A subtle difference in meaning or tone" },
    { front: "Figurative", back: "Words used imaginatively, not literally" },
    { front: "Precise", back: "Exact and accurate in word choice" },
  ]},
...
const SUBJECT_DECK = {
  ...
  "english-a": "english-a",
  "english-diction": "english-diction",
